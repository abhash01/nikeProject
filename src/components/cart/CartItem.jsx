    ...
    <>
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center leading-none">
            ...
            <div className="flex items-center justify-around w-full">
              <button type="button" className="bg-theme-cart rounded w-6 h-6 flex items-center justify-center active:scale-90" onClick={onDecresedItenQTY}>
                <MinusIcon className="w-5 h-5 lg:w-4 lg:h-4 text-white stroke-[2]" />
              </button>
              <div className="bg-theme-cart rounded flex items-center justify-center text-white font-medium lg:text-sm w-7 h-6 lg:w-6 lg:h-5">{cartQuantity}</div>
              <button type="button" className="bg-theme-cart rounded w-6 h-6 flex items-center justify-center active:scale-90" onClick={onIncreasedItenQTY}>
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            <button type="button" onClick={onRemovedItem} className="bg-theme-cart rounded p-1 lg:p-0.5 grid items-center justify-items-center cursor-pointer">
